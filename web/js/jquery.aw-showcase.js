...
(function(jQuery) {
	...
	jQuery.fn.awShowcase = function(options) {
        ...
        var resolution = $('#top-slider').width();

		// Default configuration properties
		var defaults =
		{
			content_width:			resolution-20,
			content_height:			(resolution-20)/2.55,
			fit_to_parent:			false,
			auto:					false,
			interval:				3000,
			continuous:				false,
        ...
        $('.showcase-thumbnail').css('height', (options.content_height - 32)/3 + 1);
        $('.showcase-thumbnail-cover').css('top', (options.content_height - 32)/5.6 - 5);
